    ...
    >
      <div className="container mx-auto px-4 py-2 flex items-center justify-between">
        ...
        >
          <Link
            to="/"
            className="text-[#003138] hover:text-[#003138]/80 font-medium"
          >
            Halaman Utama
          </Link>
          ...
          <div className="relative">
            <button
              ...
              onMouseEnter={() => handleDropdownHover("profil")}
              className="flex items-center space-x-1 text-[#003138] hover:text-[#003138]/80 font-medium"
            >
              <span>Profil</span>
              <ChevronDown
            ...
            {activeDropdown === "profil" && (
              <div
                className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-[var(--shadow-dropdown)] border border-gray-200 py-2 z-50"
          ...
          <div className="relative">
            <button
              ...
              onMouseEnter={() => handleDropdownHover("produk")}
              className="flex items-center space-x-1 text-[#003138] hover:text-[#003138]/80 font-medium"
            >
              <span>Produk</span>
              <ChevronDown
                className={`w-4 h-4 transition-transform duration-200 ${
                  activeDropdown === "produk" ? "rotate-180" : ""
                }`}
              />
            </button>
            {activeDropdown === "produk" && (
              <div
                className="absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-[var(--shadow-dropdown)] border border-gray-200 py-2 z-50 max-h-96 overflow-y-auto"
                onMouseEnter={handleDropdownEnter}
                onMouseLeave={handleMouseLeave}
              >
                {loading ? (
          ...
          <div className="relative">
            <button
              ...
              onMouseEnter={() => handleDropdownHover("berita")}
              className="flex items-center space-x-1 text-[#003138] hover:text-[#003138]/80 font-medium"
            >
              <span>Berita</span>
              <ChevronDown
        ...
        <button
          ...
          className="md:hidden text-[#003138] hover:text-[#003138]/80 rounded-md transition-colors"
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
          <nav className="container mx-auto px-4 py-4 space-y-4">
            <Link
              to="/"
              className="block text-[#003138] hover:text-[#003138]/80 font-medium py-2"
            ...
            <div>
              <button
                onClick={() => handleDropdownToggle("profil-mobile")}
                className="flex items-center justify-between w-full text-[#003138] hover:text-[#003138]/80 font-medium py-2"
              >
                <span>Profil</span>
                <ChevronDown
                  className={`w-4 h-4 transition-transform duration-200 ${
                    activeDropdown === "profil-mobile" ? "rotate-180" : ""
                  }`}
                />
              </button>
              {activeDropdown === "profil-mobile" && (
                <div className="ml-4 mt-2 space-y-2">
                  <Link
                    to="/profil/tentang-perusahaan"
                    className="block text-gray-600 hover:text-[#003138] py-2"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    Tentang Perusahaan
                  </Link>
            ...
            <div>
              <button
                onClick={() => handleDropdownToggle("produk-mobile")}
                className="flex items-center justify-between w-full text-[#003138] hover:text-[#003138]/80 font-medium py-2"
              >
                <span>Produk</span>
                <ChevronDown
                  className={`w-4 h-4 transition-transform duration-200 ${
                    activeDropdown === "produk-mobile" ? "rotate-180" : ""
                  }`}
                />
              </button>
            ...
            <div>
              <button
                onClick={() => handleDropdownToggle("berita-mobile")}
                className="flex items-center justify-between w-full text-[#003138] hover:text-[#003138]/80 font-medium py-2"
              >
                <span>Berita</span>
                <ChevronDown
                  className={`w-4 h-4 transition-transform duration-200 ${
                    activeDropdown === "berita-mobile" ? "rotate-180" : ""
                  }`}
                />
              </button>
