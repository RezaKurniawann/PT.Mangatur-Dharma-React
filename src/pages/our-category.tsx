...
const contents = [
  ...
  {
    title: "Industrial",
    img: `${import.meta.env.BASE_URL}/assets/img/item/category/ktgr3.png`,
    desc: "Kami juga memiliki filtrasi untuk sistem Industri yang dirancang untuk kebutuhan pabrik, manufaktur, pembangkit listrik, fasilitas pengolahan dan lainnya. Filter kami membantu menjaga kualitas operasional mesin dan sistem agar tetap efisien, minim gangguan, dan memperpanjang umur peralatan industri.",
  },
  {
    title: "Sistem Tata Udara",
    img: `${import.meta.env.BASE_URL}/assets/img/item/category/ktgr4.png`,
    desc: "Solusi untuk Filter udara berkualitas untuk Sistem Tata Udara (HVAC) yang bersih dan sehat. Filter HVAC kami menyediakan berbagai produk yang dirancang untuk menjaga kualitas udara dalam gedung komersial, rumah sakit, F&B, dan fasilitas lain yang membutuhkan pengendalian udara bersih dan Sehat. Filter kami membantu mengurangi polutan, debu, bau, dan mikroorganisme sehingga menciptakan lingkungan yang lebih sehat.",
  },
];
    ...
    <Layout>
      <div className="relative bg-gradient-to-r from-primary to-primary/90 text-white py-10 md:py-18">
        ...
        <div className="absolute bottom-0 right-12 mr-10 transform translate-x-1/4 translate-y-1/4">
          <img
            src={`${import.meta.env.BASE_URL}/assets/img/item/icon-5.png`}
            alt="About Us"
